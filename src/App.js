...
import MultiDesc from "./components/About/MultiDesc";
      ...
      <div>
        ...
        <div>
          <Switch>
            ...
            <Route path="/E-waste" component={Video}/>
            <Route path="/E-wastedefine" component={MultiDesc}/>
            <Route path="/Data-Destruction" component={OurService}/>
